...
def search_products():
    ...
    return jsonify([{
        ...
        'uom': p.uom_ref.name if p.uom_ref else 'pcs',
        'tax_rate': float(p.tax_master_ref.percentage) if p.tax_master_ref else 18.0,
        'tax_code': p.tax_master_ref.code if p.tax_master_ref else 'GST18',
